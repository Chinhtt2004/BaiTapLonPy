...
p2 = "Aaron Hickey"  # Thay tên cầu thủ 
attributes = ["Playing time_Starts", "Playing time_Matches played", "Performance_Penalty Goals"]  # Thay đổi danh sách các chỉ số muốn so sánh
